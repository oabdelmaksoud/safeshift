...
| 5 | if_fusion_adc | fusion → adc | Ethernet | 0.81 | HIGH |
| 6 | if_adc_brake | adc → brake | FlexRay | 0.75 | HIGH |
| 7 | if_adc_steer | adc → steer | FlexRay | 0.75 | HIGH |
| 8 | if_cam_vpm | cam_front → vpm | Ethernet | 0.59 | MEDIUM |
...
- **if_fusion_adc** (risk 0.81): safety-related, timing-critical, target sits in a dependency cycle, higher-complexity protocol, involves an immature component, high ASIL safety level.
